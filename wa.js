async function CreateWhatsappChatWidget(
  option = {
    brandSetting: {
      ...
      brandImgData: null,
      brandName: 'Zarin Solutions',
      brandSubTitle: '',
      ctaText: 'Chat with us',
      welcomeText: 'I have some questions about Zarin Solutions, \ncan you help?',
      messageText: 'I’ve some questions about Zarin Solutions, can you help?',
    ...
    document.querySelector('#whatsapp-chat-widget')?.insertAdjacentHTML(
      ...
      `<div class='wa-chat-box'>
                 <img class='wa-chat-box-brand'
                    onError='this.src= "https://anas.zarin.solutions/assets/images/me2.webp";' 
        ...
        ''
                ...
                <div class='wa-chat-box-poweredby'>
                    ...
                    Powered by <a href="https://zarinsolutions.com/" target="_blank" class="wa-chat-box-poweredby-link">zarin.solutions</a>
                </div>
            </div>
            `
    );
